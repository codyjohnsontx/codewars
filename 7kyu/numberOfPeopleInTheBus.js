...
// represent the number of people that get on the bus (the first item) and the number of people that get off the bus (the second item) at a bus stop.

// Your task is to return the number of people who are still on the bus after the 
// last bus stop (after the last array). Even though it is the last bus stop, the bus
//  might not be empty and some people might still be inside the bus, they are probably sleeping there :D
...
// Always a number
// Bus starts at zero people (0)
// Always will be zero or greater than, never negative 
// [[1,0], [5,4], [10,8], [1,3]] --> [17 on,  15 off] -> 2 left on bus
